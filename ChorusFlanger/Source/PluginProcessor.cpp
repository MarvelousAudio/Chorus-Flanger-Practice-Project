...
//==============================================================================
const String Chorus_flangerAudioProcessor::getName() const
{
...
const String Chorus_flangerAudioProcessor::getProgramName (int index)
{
    return {};
}

void Chorus_flangerAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void Chorus_flangerAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* Chorus_flangerAudioProcessor::createEditor()
{
    return new Chorus_flangerAudioProcessorEditor (*this);
}

//==============================================================================
void Chorus_flangerAudioProcessor::getStateInformation (MemoryBlock& destData)
{
